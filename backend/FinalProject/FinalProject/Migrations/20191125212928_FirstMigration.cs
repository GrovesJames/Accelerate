...
namespace FinalProject.Migrations
{
    public partial class FirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "ActivityPlans",
                columns: new[] { "Id", "Description", "Duration", "Score", "SkillsId", "Title" },
                values: new object[] { 1, "do the stuff", 20, 200, 1, "Test Activity" });
            ...
            migrationBuilder.InsertData(
                table: "Activities",
                columns: new[] { "Id", "ActivityTime", "AgeRange", "Description", "Duration", "ScheduleId", "Score" },
                values: new object[] { 1, new DateTime(2019, 11, 25, 10, 29, 27, 828, DateTimeKind.Local), "3-6", "do stuff", 20, 1, 200 });
